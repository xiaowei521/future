...
<div class="col-md-4 myleft">
    <div class="myleft-n">
        <h6>PROMULGATOR</h6>
         <a href="#" data-toggle="modal" data-target="#exampleModal2">
            <img id="tou" src="tx/22.png" class="f imgr20">
         </a>   
        <div class="f imgf20">
            <h4>noob</h4>
    ...
    <div class="myleft-n">
        ...
        <ul class="list-group">
            <li class="list-group-item">
                ...
                <i class="fa fa-user-secret"></i>&nbsp;第 116344 位会员
            </li>
            <li class="list-group-item">
                <span class="badge red">0</span>
                <i class="fa fa-btc"></i>&nbsp;我的jQ币
            </li>
            <li class="list-group-item">
                <span class="badge">0</span>
                <i class="fa fa-heart"></i>&nbsp;关注我的人数
            </li>
        </ul>


        <a class="btn btn-success" href="zxzf.aspx" target="_blank" style="width: 100%"><i class="fa fa-jpy"></i>购买jQ币</a>
        <a class="btn btn-info top10" href="jquerySubmit.aspx" style="width: 100%">发布资源获得jQ币</a>

        <div class="alert alert-warning top20" role="alert" style="background-color:#fefcee;padding-top:7px;padding-bottom:7px">
            <i class="fa fa-lightbulb-o"></i> 最新修复上传插件中代码内容过滤问题！<br />
    ...
    <div class="df"></div>
			  ...
			  <div class="col-md-8 myright">
			  		<div class="myright-n">
						<div class="myNav row">							
							 <a href="mem116344"><i class="fa fa-codepen"></i> 我发布的插件</a>
							 <a href="msc116344"><i class="fa fa-heart"></i> 我收藏的插件</a>
                             <a href="#"><i class="fa fa-user"></i> 资料</a>
                             <a href="#">账号</a>
                             <a href="#" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-pencil-square-o"></i> 签到</a>
						 </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">       
          <iframe src="signIn.aspx" width="100%" height="100%" frameborder="0" ></iframe>
      </div>      
    </div>
  </div>
</div>
...
<div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="exampleModalLabel2"><i class="fa fa-picture-o"></i> 设置头像</h4>
      </div>
      <div class="modal-body" style="height:550px">       
          <iframe name="myFrame" src="myPhoto.aspx" width="100%" height="100%" frameborder="0" ></iframe>
      </div>  
      <div class="modal-footer">
           <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
           <button type="button" class="btn btn-primary" onclick="tx()" data-dismiss="modal">保存头像</button>
      </div>    
    </div>
  </div>
</div>
